...
public class Form_Categoria extends javax.swing.JDialog {

    ConfigGeneral config = new ConfigGeneral();
    CategoriaImpl controlador = new CategoriaImpl(); //llamamos al mentenimiento general del objeto
    ...
    int id_categoria = 0, ver = 0;
    private int id_usuario = 0, id_sede = 0;

    public static int valor = 0;

    public Form_Categoria(java.awt.Frame parent, boolean modal, int id_categoria,
        ...
        this.setTitle("REGISTRO DE CATEGORÍAS");
        JTF.modelo_1TF(txtDescripcion, opcion_visual);
        lblIdEmpresa.setText(id_categoria + "");
...
//        validar.validarSoloNumeros(txtDescripcion);
        if (id_categoria == 0) {
            ...
            controlador.buscar_por_id(id_categoria);
            String descripcion = controlador.getObCategoria().getDescripcion();
//            ////////////////////////////////////////////////////////////////////////////
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try {
            if (id_categoria == 0) {
                ...
                String consulta = "Select descripcion from categoria where descripcion='" + leeDescripcion() + "' "
                        + " and estado='1'  and estado='" + id_sede + "'";
                if (controlador.valida_Campos(consulta)) {
                    JOptionPane.showMessageDialog(null, "La Categorìa ingresada ya existe.", "Mensaje", JOptionPane.INFORMATION_MESSAGE);
                    txtDescripcion.setText("");
                    txtDescripcion.requestFocusInWindow();
                    return;
                }
                ObCategoria categoria = new ObCategoria(0, leeDescripcion(), 1, id_usuario, id_sede);
                ...
                String consulta = "Select descripcion from categoria where descripcion='" + leeDescripcion() + "' and "
                        + " id_categoria='" + leeId() + "'  and estado='1'  and estado='" + id_sede + "'";
                if (!controlador.valida_Campos(consulta)) {
                    String consulta_reg = "Select descripcion from categoria where "
                            + " descripcion='" + leeDescripcion() + "'  and estado='" + id_sede + "'";
                ...
                ObCategoria categoria = new ObCategoria(leeId(), leeDescripcion(), 1, id_usuario, id_sede);
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_Categoria dialog = new Form_Categoria(new javax.swing.JFrame(), true, 0, 0, 0, 0);
