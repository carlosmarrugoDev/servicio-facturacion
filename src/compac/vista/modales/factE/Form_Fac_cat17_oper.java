...
public class Form_Fac_cat17_oper extends javax.swing.JDialog {

    ConfigGeneral config = new ConfigGeneral();
    Fac_cat17_operImpl controlador = new Fac_cat17_operImpl(); //llamamos al mentenimiento general del objeto
...
//        this.id_sedes=id_usuarios;
    ...
    public Form_Fac_cat17_oper(java.awt.Frame parent, boolean modal, int idrecepcionado, int ver) {
        super(parent, modal);
        initComponents();

        this.setLocationRelativeTo(null);
        this.setTitle("REGISTRO DE TIPO DE OPERACIONES");
...
//            ////////////////////////////////////////////////////////////////////////////
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try {
            if (idrecepcionado == 0) {
                String consulta = "Select descripcion from fac_cat2_moneda where descripcion='" + leeDescripcion() + "' ";
                ...
                ObFac_cat17_oper fac_cat2 = new ObFac_cat17_oper(0, leeCodigo(), leeDescripcion(), 1);
                controlador.registrar(fac_cat2);
                ...
                String consulta = "Select descripcion from fac_cat2_moneda where descripcion='" + leeDescripcion() + "' and "
                        + " id_fac_cat2_moneda='" + leeId() + "'  ";
                if (!controlador.valida_Campos(consulta)) {
                    String consulta_reg = "Select descripcion from fac_cat2_moneda where descripcion='" + leeDescripcion() + "'";
                ...
                ObFac_cat17_oper fac_cat2 = new ObFac_cat17_oper(leeId(), leeCodigo(), leeDescripcion(), 1);
                controlador.actualizar(fac_cat2);
                this.dispose();
            ...
            System.err.println("error al registrar fac_cat2_moneda " + e.getLocalizedMessage());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Fac_cat17_oper.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_Fac_cat17_oper dialog = new Form_Fac_cat17_oper(new javax.swing.JFrame(), true, 0, 0);
