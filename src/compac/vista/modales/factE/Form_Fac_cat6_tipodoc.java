...
public class Form_Fac_cat6_tipodoc extends javax.swing.JDialog {

    ConfigGeneral config = new ConfigGeneral();
    Fac_cat6_TipodocImpl controlador = new Fac_cat6_TipodocImpl(); //llamamos al mentenimiento general del objeto
...
//        this.id_sedes=id_usuarios;
    ...
    public Form_Fac_cat6_tipodoc(java.awt.Frame parent, boolean modal, int idrecepcionado, int ver) {
        super(parent, modal);
        initComponents();
...
//        validar.validarSoloNumeros(txtDescripcion);
        if (idrecepcionado == 0) {
            ...
            String codigo = controlador.getObTipodoc().getCodigo();
            String descripcion = controlador.getObTipodoc().getDescripcion();
            String simbolo = controlador.getObTipodoc().getSimbolo();
            int longitud = controlador.getObTipodoc().getLongitud();
//            ////////////////////////////////////////////////////////////////////////////
...
//            String codigo, int estado_view
                ObFac_cat6_Tipodoc tipodocs = new ObFac_cat6_Tipodoc(0, leeDescripcion(),
                ...
                ObFac_cat6_Tipodoc tipodocs = new ObFac_cat6_Tipodoc(leeId(), leeDescripcion(),
                        1, leeLongitud(), leeCodigo(), 1, leeSimbolo());
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Fac_cat6_tipodoc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_Fac_cat6_tipodoc dialog = new Form_Fac_cat6_tipodoc(new javax.swing.JFrame(), true, 0, 0);
