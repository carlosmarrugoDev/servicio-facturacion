...
public class Form_Fac_cat8_isc extends javax.swing.JDialog {

    ConfigGeneral config = new ConfigGeneral();
    Fac_cat8_iscImpl controlador = new Fac_cat8_iscImpl(); //llamamos al mentenimiento general del objeto
...
//        this.id_sedes=id_usuarios;
    ...
    public Form_Fac_cat8_isc(java.awt.Frame parent, boolean modal, int idrecepcionado, int ver) {
        super(parent, modal);
        initComponents();

        this.setLocationRelativeTo(null);
        this.setTitle("REGISTRO DE SIST. DE CÀLCULO DEL ISC");
...
//            ////////////////////////////////////////////////////////////////////////////
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try {
            if (idrecepcionado == 0) {
                String consulta = "Select descripcion from fac_cat8_isc where descripcion='" + leeDescripcion() + "' ";
                ...
                ObFac_cat8_isc fac_cat8 = new ObFac_cat8_isc(0, leeCodigo(), leeDescripcion(), 1);
                controlador.registrar(fac_cat8);
                ...
                String consulta = "Select descripcion from fac_cat8_isc where descripcion='" + leeDescripcion() + "' and "
                        + " id_fac_cat8_isc='" + leeId() + "'  ";
                if (!controlador.valida_Campos(consulta)) {
                    String consulta_reg = "Select descripcion from fac_cat8_isc where descripcion='" + leeDescripcion() + "'";
                ...
                ObFac_cat8_isc fac_cat8 = new ObFac_cat8_isc(leeId(), leeCodigo(), leeDescripcion(), 1);
                controlador.actualizar(fac_cat8);
                this.dispose();
            ...
            System.err.println("error al registrar fac_cat8_isc " + e.getLocalizedMessage());
        }
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Fac_cat8_isc.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_Fac_cat8_isc dialog = new Form_Fac_cat8_isc(new javax.swing.JFrame(), true, 0, 0);
