...
public class Form_Fac_cat2_moneda extends javax.swing.JDialog {

    ConfigGeneral config = new ConfigGeneral();
    Fac_cat2_monedaImpl controlador = new Fac_cat2_monedaImpl(); //llamamos al mentenimiento general del objeto
...
//        this.id_sedes=id_usuarios;
    ...
    public Form_Fac_cat2_moneda(java.awt.Frame parent, boolean modal, int idrecepcionado, int ver) {
        super(parent, modal);
        initComponents();
...
//            ////////////////////////////////////////////////////////////////////////////
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try {
            if (idrecepcionado == 0) {
                ...
                ObFac_cat2_moneda fac_cat2 = new ObFac_cat2_moneda(0, leeCodigo(), leeDescripcion(), 1);
                ...
                ObFac_cat2_moneda fac_cat2 = new ObFac_cat2_moneda(leeId(), leeCodigo(), leeDescripcion(), 1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Fac_cat2_moneda.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_Fac_cat2_moneda dialog = new Form_Fac_cat2_moneda(new javax.swing.JFrame(), true, 0, 0);
