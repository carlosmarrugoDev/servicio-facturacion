...
public class Form_Fac_cat7_igv extends javax.swing.JDialog {

    ConfigGeneral config = new ConfigGeneral();
    Fac_cat7_igvImpl controlador = new Fac_cat7_igvImpl(); //llamamos al mentenimiento general del objeto
...
//        this.id_sedes=id_usuarios;
    ...
    public Form_Fac_cat7_igv(java.awt.Frame parent, boolean modal, int idrecepcionado, int ver) {
        super(parent, modal);
        initComponents();
...
//            ////////////////////////////////////////////////////////////////////////////
    ...
    private void btnRegistrarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnRegistrarActionPerformed
        ...
        try {
            if (idrecepcionado == 0) {
                ...
                ObFac_cat7_igv cat7_igv = new ObFac_cat7_igv(0, leeCodigo(), leeDescripcion(),
                        leeCodigoTributo(), 1);
                ...
                ObFac_cat7_igv cat7_igv = new ObFac_cat7_igv(leeId(), leeCodigo(), leeDescripcion(),
                        leeCodigoTributo(), 1);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(Form_Fac_cat7_igv.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                Form_Fac_cat7_igv dialog = new Form_Fac_cat7_igv(new javax.swing.JFrame(), true, 0, 0);
