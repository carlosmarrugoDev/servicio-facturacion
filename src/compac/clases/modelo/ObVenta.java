...
public class ObVenta {
    ...
    private String respuesta_sunat, tipofac, codigo_tipofac;
    

    public ObVenta(int id_venta, String documento, String fecha, Time hora, int id_cliente, String moneda, double igv, double sub_total,
            double total_venta, String leyenda, double totalExonerado, double totalGravado, int id_usuario, int id_sede, int procesado,
            String respuesta_sunat, String tipofac, String codigo_tipofac) {
